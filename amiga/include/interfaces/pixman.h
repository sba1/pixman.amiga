...
struct PixmanIFace
{
	...
	pixman_bool_t APICALL (*pixman_transform_multiply)(struct PixmanIFace *Self,  struct pixman_transform * dst, const struct pixman_transform * l, const struct pixman_transform * r);
	...
	pixman_bool_t APICALL (*pixman_transform_bounds)(struct PixmanIFace *Self, const struct pixman_transform * matrix,  struct pixman_box16 * b);
	pixman_bool_t APICALL (*pixman_transform_invert)(struct PixmanIFace *Self,  struct pixman_transform * dst, const struct pixman_transform * src);
	pixman_bool_t APICALL (*pixman_transform_is_identity)(struct PixmanIFace *Self, const struct pixman_transform * t);
	pixman_bool_t APICALL (*pixman_transform_is_scale)(struct PixmanIFace *Self, const struct pixman_transform * t);
	pixman_bool_t APICALL (*pixman_transform_is_int_translate)(struct PixmanIFace *Self, const struct pixman_transform * t);
	pixman_bool_t APICALL (*pixman_transform_is_inverse)(struct PixmanIFace *Self, const struct pixman_transform * a, const struct pixman_transform * b);
	pixman_bool_t APICALL (*pixman_transform_from_pixman_f_transform)(struct PixmanIFace *Self,  struct pixman_transform * t, const struct pixman_f_transform * ft);
	void APICALL (*pixman_f_transform_from_pixman_transform)(struct PixmanIFace *Self,  struct pixman_f_transform * ft, const struct pixman_transform * t);
	pixman_bool_t APICALL (*pixman_f_transform_invert)(struct PixmanIFace *Self,  struct pixman_f_transform * dst, const struct pixman_f_transform * src);
	pixman_bool_t APICALL (*pixman_f_transform_point)(struct PixmanIFace *Self, const struct pixman_f_transform * t,  struct pixman_f_vector * v);
	void APICALL (*pixman_f_transform_point_3d)(struct PixmanIFace *Self, const struct pixman_f_transform * t,  struct pixman_f_vector * v);
	void APICALL (*pixman_f_transform_multiply)(struct PixmanIFace *Self,  struct pixman_f_transform * dst, const struct pixman_f_transform * l, const struct pixman_f_transform * r);
	...
	pixman_bool_t APICALL (*pixman_f_transform_bounds)(struct PixmanIFace *Self, const struct pixman_f_transform * t,  struct pixman_box16 * b);
	...
	pixman_bool_t APICALL (*pixman_region_init_rects)(struct PixmanIFace *Self,  pixman_region16_t * region, const pixman_box16_t * boxes,  int count);
	...
	pixman_bool_t APICALL (*pixman_region32_init_rects)(struct PixmanIFace *Self,  pixman_region32_t * region, const pixman_box32_t * boxes,  int count);
	...
	const char * APICALL (*pixman_version_string)(struct PixmanIFace *Self);
	...
	pixman_image_t * APICALL (*pixman_image_create_linear_gradient)(struct PixmanIFace *Self,  pixman_point_fixed_t * p1,  pixman_point_fixed_t * p2, const pixman_gradient_stop_t * stops,  int n_stops);
	pixman_image_t * APICALL (*pixman_image_create_radial_gradient)(struct PixmanIFace *Self,  pixman_point_fixed_t * inner,  pixman_point_fixed_t * outer,  pixman_fixed_t inner_radius,  pixman_fixed_t outer_radius, const pixman_gradient_stop_t * stops,  int n_stops);
	pixman_image_t * APICALL (*pixman_image_create_conical_gradient)(struct PixmanIFace *Self,  pixman_point_fixed_t * center,  pixman_fixed_t angle, const pixman_gradient_stop_t * stops,  int n_stops);
	...
	pixman_bool_t APICALL (*pixman_image_set_transform)(struct PixmanIFace *Self,  pixman_image_t * image, const pixman_transform_t * transform);
	void APICALL (*pixman_image_set_repeat)(struct PixmanIFace *Self,  pixman_image_t * image,  pixman_repeat_t repeat);
	pixman_bool_t APICALL (*pixman_image_set_filter)(struct PixmanIFace *Self,  pixman_image_t * image,  pixman_filter_t filter, const pixman_fixed_t * filter_params,  int n_filter_params);
	...
	void APICALL (*pixman_image_set_indexed)(struct PixmanIFace *Self,  pixman_image_t * image, const pixman_indexed_t * indexed);
	...
	pixman_bool_t APICALL (*pixman_image_fill_rectangles)(struct PixmanIFace *Self,  pixman_op_t op,  pixman_image_t * image,  pixman_color_t * color,  int n_rects, const pixman_rectangle16_t * rects);
	pixman_bool_t APICALL (*pixman_image_fill_boxes)(struct PixmanIFace *Self,  pixman_op_t op,  pixman_image_t * dest,  pixman_color_t * color,  int n_boxes, const pixman_box32_t * boxes);
	...
	const void * APICALL (*pixman_glyph_cache_lookup)(struct PixmanIFace *Self,  pixman_glyph_cache_t * cache,  void * font_key,  void * glyph_key);
	const void * APICALL (*pixman_glyph_cache_insert)(struct PixmanIFace *Self,  pixman_glyph_cache_t * cache,  void * font_key,  void * glyph_key,  int origin_x,  int origin_y,  pixman_image_t * glyph_image);
	...
	void APICALL (*pixman_line_fixed_edge_init)(struct PixmanIFace *Self,  pixman_edge_t * e,  int bpp,  pixman_fixed_t y, const pixman_line_fixed_t * line,  int x_off,  int y_off);
	...
	void APICALL (*pixman_add_trapezoids)(struct PixmanIFace *Self,  pixman_image_t * image,  int16_t x_off,  int y_off,  int ntraps, const pixman_trapezoid_t * traps);
	void APICALL (*pixman_rasterize_trapezoid)(struct PixmanIFace *Self,  pixman_image_t * image, const pixman_trapezoid_t * trap,  int x_off,  int y_off);
	void APICALL (*pixman_composite_trapezoids)(struct PixmanIFace *Self,  pixman_op_t op,  pixman_image_t * src,  pixman_image_t * dst,  pixman_format_code_t mask_format,  int x_src,  int y_src,  int x_dst,  int y_dst,  int n_traps, const pixman_trapezoid_t * traps);
	void APICALL (*pixman_composite_triangles)(struct PixmanIFace *Self,  pixman_op_t op,  pixman_image_t * src,  pixman_image_t * dst,  pixman_format_code_t mask_format,  int x_src,  int y_src,  int x_dst,  int y_dst,  int n_tris, const pixman_triangle_t * tris);
	void APICALL (*pixman_add_triangles)(struct PixmanIFace *Self,  pixman_image_t * image,  int32_t x_off,  int32_t y_off,  int n_tris, const pixman_triangle_t * tris);
};
