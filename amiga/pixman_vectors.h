...
extern pixman_bool_t        VARARGS68K _impl_pixman_transform_point_3d(struct PixmanIFace *, struct pixman_transform * transform, struct pixman_vector * vector);
extern pixman_bool_t        VARARGS68K _impl_pixman_transform_point(struct PixmanIFace *, struct pixman_transform * transform, struct pixman_vector * vector);
extern pixman_bool_t        VARARGS68K _impl_pixman_transform_multiply(struct PixmanIFace *, struct pixman_transform * dst, struct pixman_transform * l, struct pixman_transform * r);
...
extern pixman_bool_t        VARARGS68K _impl_pixman_transform_bounds(struct PixmanIFace *, struct pixman_transform * matrix, struct pixman_box16 * b);
extern pixman_bool_t        VARARGS68K _impl_pixman_transform_invert(struct PixmanIFace *, struct pixman_transform * dst, struct pixman_transform * src);
extern pixman_bool_t        VARARGS68K _impl_pixman_transform_is_identity(struct PixmanIFace *, struct pixman_transform * t);
extern pixman_bool_t        VARARGS68K _impl_pixman_transform_is_scale(struct PixmanIFace *, struct pixman_transform * t);
extern pixman_bool_t        VARARGS68K _impl_pixman_transform_is_int_translate(struct PixmanIFace *, struct pixman_transform * t);
extern pixman_bool_t        VARARGS68K _impl_pixman_transform_is_inverse(struct PixmanIFace *, struct pixman_transform * a, struct pixman_transform * b);
extern pixman_bool_t        VARARGS68K _impl_pixman_transform_from_pixman_f_transform(struct PixmanIFace *, struct pixman_transform * t, struct pixman_f_transform * ft);
extern void                 VARARGS68K _impl_pixman_f_transform_from_pixman_transform(struct PixmanIFace *, struct pixman_f_transform * ft, struct pixman_transform * t);
extern pixman_bool_t        VARARGS68K _impl_pixman_f_transform_invert(struct PixmanIFace *, struct pixman_f_transform * dst, struct pixman_f_transform * src);
extern pixman_bool_t        VARARGS68K _impl_pixman_f_transform_point(struct PixmanIFace *, struct pixman_f_transform * t, struct pixman_f_vector * v);
extern void                 VARARGS68K _impl_pixman_f_transform_point_3d(struct PixmanIFace *, struct pixman_f_transform * t, struct pixman_f_vector * v);
extern void                 VARARGS68K _impl_pixman_f_transform_multiply(struct PixmanIFace *, struct pixman_f_transform * dst, struct pixman_f_transform * l, struct pixman_f_transform * r);
...
extern pixman_bool_t        VARARGS68K _impl_pixman_f_transform_bounds(struct PixmanIFace *, struct pixman_f_transform * t, struct pixman_box16 * b);
...
extern pixman_bool_t        VARARGS68K _impl_pixman_region_init_rects(struct PixmanIFace *, pixman_region16_t * region, pixman_box16_t * boxes, int count);
...
extern pixman_bool_t        VARARGS68K _impl_pixman_region32_init_rects(struct PixmanIFace *, pixman_region32_t * region, pixman_box32_t * boxes, int count);
...
extern char *               VARARGS68K _impl_pixman_version_string(struct PixmanIFace *);
...
extern pixman_image_t *     VARARGS68K _impl_pixman_image_create_linear_gradient(struct PixmanIFace *, pixman_point_fixed_t * p1, pixman_point_fixed_t * p2, pixman_gradient_stop_t * stops, int n_stops);
extern pixman_image_t *     VARARGS68K _impl_pixman_image_create_radial_gradient(struct PixmanIFace *, pixman_point_fixed_t * inner, pixman_point_fixed_t * outer, pixman_fixed_t inner_radius, pixman_fixed_t outer_radius, pixman_gradient_stop_t * stops, int n_stops);
extern pixman_image_t *     VARARGS68K _impl_pixman_image_create_conical_gradient(struct PixmanIFace *, pixman_point_fixed_t * center, pixman_fixed_t angle, pixman_gradient_stop_t * stops, int n_stops);
...
extern pixman_bool_t        VARARGS68K _impl_pixman_image_set_transform(struct PixmanIFace *, pixman_image_t * image, pixman_transform_t * transform);
extern void                 VARARGS68K _impl_pixman_image_set_repeat(struct PixmanIFace *, pixman_image_t * image, pixman_repeat_t repeat);
extern pixman_bool_t        VARARGS68K _impl_pixman_image_set_filter(struct PixmanIFace *, pixman_image_t * image, pixman_filter_t filter, pixman_fixed_t * filter_params, int n_filter_params);
...
extern void                 VARARGS68K _impl_pixman_image_set_indexed(struct PixmanIFace *, pixman_image_t * image, pixman_indexed_t * indexed);
...
extern pixman_bool_t        VARARGS68K _impl_pixman_image_fill_rectangles(struct PixmanIFace *, pixman_op_t op, pixman_image_t * image, pixman_color_t * color, int n_rects, pixman_rectangle16_t * rects);
extern pixman_bool_t        VARARGS68K _impl_pixman_image_fill_boxes(struct PixmanIFace *, pixman_op_t op, pixman_image_t * dest, pixman_color_t * color, int n_boxes, pixman_box32_t * boxes);
...
extern void *               VARARGS68K _impl_pixman_glyph_cache_lookup(struct PixmanIFace *, pixman_glyph_cache_t * cache, void * font_key, void * glyph_key);
extern void *               VARARGS68K _impl_pixman_glyph_cache_insert(struct PixmanIFace *, pixman_glyph_cache_t * cache, void * font_key, void * glyph_key, int origin_x, int origin_y, pixman_image_t * glyph_image);
...
extern void                 VARARGS68K _impl_pixman_line_fixed_edge_init(struct PixmanIFace *, pixman_edge_t * e, int bpp, pixman_fixed_t y, pixman_line_fixed_t * line, int x_off, int y_off);
...
extern void                 VARARGS68K _impl_pixman_add_trapezoids(struct PixmanIFace *, pixman_image_t * image, int16_t x_off, int y_off, int ntraps, pixman_trapezoid_t * traps);
extern void                 VARARGS68K _impl_pixman_rasterize_trapezoid(struct PixmanIFace *, pixman_image_t * image, pixman_trapezoid_t * trap, int x_off, int y_off);
extern void                 VARARGS68K _impl_pixman_composite_trapezoids(struct PixmanIFace *, pixman_op_t op, pixman_image_t * src, pixman_image_t * dst, pixman_format_code_t mask_format, int x_src, int y_src, int x_dst, int y_dst, int n_traps, pixman_trapezoid_t * traps);
extern void                 VARARGS68K _impl_pixman_composite_triangles(struct PixmanIFace *, pixman_op_t op, pixman_image_t * src, pixman_image_t * dst, pixman_format_code_t mask_format, int x_src, int y_src, int x_dst, int y_dst, int n_tris, pixman_triangle_t * tris);
extern void                 VARARGS68K _impl_pixman_add_triangles(struct PixmanIFace *, pixman_image_t * image, int32_t x_off, int32_t y_off, int n_tris, pixman_triangle_t * tris);
