...
struct PixmanLibrary * PixmanBase = NULL;
static struct PixmanLibrary * __PixmanBase;

/****************************************************************************/

void pixman_base_constructor(void)
{
    if (PixmanBase != NULL)
    {
...
(*pixman_base_constructor_ptr)(void) USED = pixman_base_constructor;

/****************************************************************************/

void pixman_base_destructor(void)
{
    if (__PixmanBase)
    {
...
(*pixman_base_destructor_ptr)(void) USED = pixman_base_destructor;
